...
def lambda_handler(event, context):
    ...
    Bucket = "sisakk"
    Key = "spotify/raw_data/to_process/"
    ...
    for data in spotify_data:
        ...
        songs_key = "spotify/transformed_data/song_data/songs_transformed_" + str(datetime.now()) + ".csv"
        ...
        album_key = "spotify/transformed_data/album_data/album_transformed_" + str(datetime.now()) + ".csv"
        album_buffer=StringIO()
        album_df.to_csv(album_buffer, index=False)
        album_content = album_buffer.getvalue()
        s3.put_object(Bucket=Bucket, Key=album_key, Body=album_content)
        
        artist_key = "spotify/transformed_data/artist_data/artist_transformed_" + str(datetime.now()) + ".csv"
    ...
    for key in spotify_keys:
        ...
        s3_resource.meta.client.copy(copy_source, Bucket, 'spotify/raw_data/processed/' + key.split("/")[-1])    
